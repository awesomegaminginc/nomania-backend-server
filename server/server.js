...
app.get('/', (req, res) => {
    ...
    console.log(`ANDY: I just recieved ${(req.secure) ? "an in":"a "}connection from ${req.ip}`);
});

app.listen(port, () => {
    console.log('ANDY: Hi! I\'m Andy! I\'m your helper!');
    console.log(`ANDY: Started on port ${port}`);
});
